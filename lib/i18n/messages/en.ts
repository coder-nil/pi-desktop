...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "i18n.pluginCatalogIntro": "Browse the built-in Pi package catalog. Each item shows a reviewed Chinese summary when available, plus the author's original description; online searches can add newer packages.",
