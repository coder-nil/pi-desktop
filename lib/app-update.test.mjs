...
test("detects newer stable and prerelease Pi Desktop versions", () => {
  ...
  assert.equal(isNewerVersion("0.84.2-aphla.2", "0.84.2-aphla.1"), true);
...
test("normalizes tags and builds this repository's release URL", () => {
  assert.equal(normalizeVersion("v0.84.2-aphla.1"), "0.84.2-aphla.1");
  assert.equal(
    getPiDesktopReleaseUrl("0.84.2-aphla.1"),
    "https://github.com/mafousoftware/pi-desktop/releases/tag/v0.84.2-aphla.1",
  );
