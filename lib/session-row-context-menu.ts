export const SESSION_ROW_CONTEXT_MENU_EVENT = "pi-desktop:session-row-contextmenu";
...
declare global {
  interface WindowEventMap {
    "pi-desktop:session-row-contextmenu": CustomEvent<SessionRowContextMenuDetail>;
  }
}
