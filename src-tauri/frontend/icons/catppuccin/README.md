...
- `latte/` is used in Pi Desktop's light theme.
- `mocha/` is used in Pi Desktop's dark theme.
- Pi Desktop uses the SVG alpha channel as a mask and applies `var(--text-dim)`,
