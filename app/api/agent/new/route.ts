...
export async function POST(req: Request) {
  ...
  try {
    ...
    const { provider, modelId, toolNames, thinkingLevel, uiLocale, ...promptCommand } = command as { provider?: string; modelId?: string; toolNames?: string[]; thinkingLevel?: unknown; uiLocale?: unknown; [key: string]: unknown };
